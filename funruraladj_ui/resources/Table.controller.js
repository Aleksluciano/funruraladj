sap.ui.define([
	...
	return BaseController.extend("funruraladj_ui.Table", {
		onInit: function () {
			...
			xhttp.open("GET", "/funrural/vigencia/alldata", true);
			xhttp.send();
		...
		save: function () {
			...
			if (oData2.SelectedCompany == 0 || oData2.SelectedBranch == 0) {
			...
			var xhttp = new XMLHttpRequest();
			xhttp.open("POST", "/funrural/vigencia/add", true);
		...
		save2: function () {
			...
			var xhttp = new XMLHttpRequest();
			xhttp.open("PATCH", "/funrural/vigencia/edit", true);
			xhttp.setRequestHeader('content-type', 'application/json');
		...
		onDelete: function (e) {
			...
			var xhttp = new XMLHttpRequest();
			xhttp.open("DELETE", "/funrural/vigencia/delete", true);
			xhttp.setRequestHeader('content-type', 'application/json');
